  ...
  return (
    ...
    <div className="row my-4 fi-toggle-section fi-toggle-section-styling">
            ...
            <div className='view-all-btn-container d-flex'>
               ...
               <div className='view-all-single-btn-container'>
               <a href='https://indusmela.in/collections/esplanade' rel="noreferrer" target='_blank' className="btn btn-primary view-all-btn py-3 " aria-label='explore'>Explore MORE</a>
               </div>
             </div>
